        ...
        self.jumper = Jumper(
            {
                ...
                "--content-tab-query-pane": "f",
                "--content-tab-auth-pane": "p",
                "--content-tab-info-pane": "b",
                "--content-tab-options-pane": "j",
                "--content-tab-response-body-pane": "a",
                "--content-tab-response-headers-pane": "r",
                "--content-tab-response-cookies-pane": "s",
                "--content-tab-response-trace-pane": "t",
            },
            screen=self.screen,
        )
